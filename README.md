...
Approved public DNS definitions live in `registry/domains/`. DNS destinations and ownership identifiers are public. Never include passwords, API credentials, private keys or personal contact details in requests.
